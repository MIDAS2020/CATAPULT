...
AdaTreeNat_Mining::AdaTreeNat_Mining(DatasetReader* dataset_reader, bool is_Relaxed_Support, bool is_Log_Relaxed_Support,
	...
	for (mapTreeIterator iter = ClosedMapTree->begin(); iter != ClosedMapTree->end(); ++iter) {
		//cout << "iter->first:" << iter->first << "  mBatchSize:" << mBatchSize << endl;
	...
	////////////////////////////////////////////////
	closed_tree_mining->print_Closed_Trees("Tree1.txt");
	...
	while (!blEndOfFile) {
		...
		////////////////////////////////////////////////
		closed_tree_mining->print_Closed_Trees("Tree2.txt");
		...
		////////////////////////////////////////////////
		closed_tree_mining->print_Closed_Trees("Tree3.txt");
...
void AdaTreeNat_Mining::Add(mapTree * ClosedMapTree) {
	...
	if (mclosedTrees->updateSupportAdd(t->get_TreeNodes_(), SupportT2) == false) {
		...
		//从LatticeTreeList中找到t的 smallest size super-tree  treeclosure
		...
		//cout << "support_factory->RelativeSupport(closure_support):" << support_factory->RelativeSupport(closure_support) << endl;
		//cout << "closure_support:" << closure_support << endl;
		//cout << "mWindowSize:" << *mWindowSize << endl;
		//cout << "mBatchSize:" << mBatchSize << endl;
		//cout << "SupportT2:" << SupportT2 << endl;
		//cout << "AbsSupport:" << AbsSupport << endl;
		if (AbsSupport > mdblmin_sup * (*mWindowSize)) {
			//cout << "vvvvv:" << t->Id_Front() << endl;
			//cout << "xxxxx:" << treeclosure.size() << endl;
			//cout << "wwwww:" << t->get_Size() << endl;
			//cout << "ddddd:" << D->at(t->Id_Front()).size() << endl;
...
void AdaTreeNat_Mining::recursive_Add(Tree * t, TreeDataSet * D, SupportContainer * SupportDataset, list<TreeNodes*> * list_Insert_TreeNodes, list<int> * list_Insert_Support) {
	...
	void AdaTreeNat_Mining::recursive_Delete(Tree * t, TreeDataSet * D, int min_sup, SupportContainer * SupportDataset, listTree * TreesCheckClosureList) {
		...
		TreeNodes AdaTreeNat_Mining::treesIntersection(TreeNodes t1, TreeNodes t2) {
			...
			if (closed_tree_mining->get_ClosedMapTree()->size() == 0) {
				//cout << "AdaNatMining,  ClosedMapTree is NULL!" << endl;
				TreeNodes ret;
				return ret;
			}
