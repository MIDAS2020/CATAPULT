 ...
 */
public class ComputeScoreThread extends NotificationThread {
	...
	public ComputeScoreThread(ArrayList<Integer> pIndex, ArrayList<ArrayList<closureEdge>> entirePatternList,
			...
			ComputeScoreThreadCompleteListener listener, int numOfPatterns, int binNum) {
