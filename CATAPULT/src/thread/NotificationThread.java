...
public abstract class NotificationThread implements Runnable {
	...
	/**
	 * An abstract function that children must implement. This function is where all
	 * work - typically placed in the run of runnable - should be placed.
	 */
	...
	/**
	 * Implementation of the Runnable interface. This function first calls doRun(),
	 * then notifies all listeners of completion.
	 */
